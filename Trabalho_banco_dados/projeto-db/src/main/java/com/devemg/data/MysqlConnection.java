...
public class MysqlConnection {
    private static String connectionString = "jdbc:mysql://localhost:3306/biblioteca?useSSL=false&useTimeZone=true&serverTimeZone=UTC&allowPublicKeyRetrieval=true";
    // root
